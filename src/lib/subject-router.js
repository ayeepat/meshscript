...
const CONTEXT_GUARD =
  ...
  'АУДИО. Сам звук ты слушать не умеешь, НО аудиозаписи к заданиям на аудирование (listening) ' +
  'расшифровываются автоматически. Если в этом сообщении есть текст с пометкой ' +
  ...
  'аудио — Google Drive, Яндекс.Диск, .mp3 — или вообще ничего), аудирование выполнить нельзя: ' +
  'НЕ выдумывай ответы, а напиши «Не могу прослушать аудио — пришлите аудиофайл или расшифровку ' +
  '(текст) записи, тогда решу эту часть». ' +
