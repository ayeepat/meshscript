...
export const DEFAULT_PROMPTS = {
  ...
  [PROMPT_CATEGORIES.TEST_ANSWER]:
    ...
    '{"answers":[{"n":1,"a":"<финальный ответ>","c":"<буква или номер варианта>"}]}\n\n' +
    ...
    'Поле "c" — НЕОБЯЗАТЕЛЬНОЕ: для вопросов с вариантами ответа укажи букву(ы) или номер(а) ' +
    'правильного варианта так, как они подписаны на экране (например "б" или "2"; несколько — через запятую). ' +
    'Если вариант не подписан буквой/номером или это вопрос на вписывание — поле "c" не добавляй.\n\n' +
    'Кроме "n", "a" и необязательного "c", других полей в JSON быть не должно. Не добавляй поле "reasoning".'
};
